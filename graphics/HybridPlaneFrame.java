...
public class HybridPlaneFrame extends JFrame implements DocumentListener {
	 JLabel nameLabel, passengerLabel, speedLabel, flagLabel, wheelsNumLabel, fuelLabel, engineLifeLabel,colorLabel;
	    ...
	    public HybridPlaneFrame(ArrayList<Vehicle> vehicles) {
	        // create labels
	    ...
	    public void createAmphibiousVehicle(ArrayList<Vehicle> vehicles) {
	        ...
	        if (createButton.isEnabled()) {
	    	    ...
	    	    String[] args = {name, String.valueOf(passengers), String.valueOf(maxSpeed),flag,String.valueOf(wheelsNum),String.valueOf(avgFuel),String.valueOf(engineLife),color};
	    	    Vehicle hybrid = factory.create(2, args); // 2 represents the hybrid plane type
	            nameField.setText("");
	            ...
	            vehicles.add(hybrid);
	            JOptionPane.showMessageDialog(this, "Hybrid plane vehicle created successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
	            setVisible(false);
	            List<String> photoNames = Arrays.asList("hybrid1.jpg", "hybrid2.png", "hybrid3.jpg");
	            @SuppressWarnings("unused")
				Photosframe photosFrame = new Photosframe(photoNames,hybrid);
	        }
	    }
}
